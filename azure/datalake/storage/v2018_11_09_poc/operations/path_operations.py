...
class PathOperations(object):
    ...
    def list(
            self, recursive, filesystem, directory=None, continuation=None, max_results=None, upn=None, x_ms_client_request_id=None, timeout=None, x_ms_date=None, custom_headers=None, raw=False, **operation_config):
        """List Paths.
        ...
        :param upn: Optional. Valid only when Hierarchical Namespace is
         ...
         in the owner and group fields of each list entry will be transformed
         from Azure Active Directory Object IDs to User Principal Names.  If
         "false", the values will be returned as Azure Active Directory Object
         IDs. The default value is false. Note that group and application
    ...
    def create(
            self, filesystem, path, resource=None, continuation=None, mode=None, cache_control=None, content_encoding=None, content_language=None, content_disposition=None, x_ms_cache_control=None, x_ms_content_type=None, x_ms_content_encoding=None, x_ms_content_language=None, x_ms_content_disposition=None, x_ms_rename_source=None, x_ms_lease_id=None, x_ms_source_lease_id=None, x_ms_properties=None, x_ms_permissions=None, x_ms_umask=None, if_match=None, if_none_match=None, if_modified_since=None, if_unmodified_since=None, x_ms_source_if_match=None, x_ms_source_if_none_match=None, x_ms_source_if_modified_since=None, x_ms_source_if_unmodified_since=None, x_ms_client_request_id=None, timeout=None, x_ms_date=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param x_ms_rename_source: An optional file or directory to be
         ...
         "/{filesystem}/{path}".  If "x-ms-properties" is specified, the
         properties will overwrite the existing properties; otherwise, the
         existing properties will be preserved. This value must be a URL
         percent-encoded string. Note that the string may only contain ASCII
        ...
        :param x_ms_properties: Optional.  User-defined properties to be
         ...
         a base64 encoded string. Note that the string may only contain ASCII
         characters in the ISO-8859-1 character set.
        ...
        :param x_ms_umask: Optional and only valid if Hierarchical Namespace
         is enabled for the account. When creating a file or directory and the
         ...
         permission is 0720.  The default permission is 0777 for a directory
         and 0666 for a file.  The default umask is 0027.  The umask must be
         specified in 4-digit octal notation (e.g. 0766).
        :type x_ms_umask: str
        ...
        if x_ms_umask is not None:
            header_parameters['x-ms-umask'] = self._serialize.header("x_ms_umask", x_ms_umask, 'str')
    ...
    def update(
            self, action, filesystem, path, position=None, retain_uncommitted_data=None, close=None, content_length=None, content_md5=None, x_ms_lease_id=None, x_ms_cache_control=None, x_ms_content_type=None, x_ms_content_disposition=None, x_ms_content_encoding=None, x_ms_content_language=None, x_ms_content_md5=None, x_ms_properties=None, x_ms_owner=None, x_ms_group=None, x_ms_permissions=None, x_ms_acl=None, if_match=None, if_none_match=None, if_modified_since=None, if_unmodified_since=None, request_body=None, x_ms_client_request_id=None, timeout=None, x_ms_date=None, custom_headers=None, raw=False, callback=None, **operation_config):
        ...
        :param content_md5: Optional. An MD5 hash of the request content. This
         header is valid on "Append" and "Flush" operations. This hash is used
         to verify the integrity of the request content during transport. When
         this header is specified, the storage service compares the hash of the
         content that has arrived with this header value. If the two hashes do
         not match, the operation will fail with error code 400 (Bad Request).
         Note that this MD5 hash is not stored with the file. This header is
         associated with the request content, and not with the stored content
         of the file itself.
        ...
        :param x_ms_content_language: Optional and only valid for flush and
         ...
         operations.
        :type x_ms_content_language: str
        :param x_ms_content_md5: Optional and only valid for "Flush & Set
         Properties" operations.  The service stores this value and includes it
         in the "Content-Md5" response header for "Read & Get Properties"
         operations. If this property is not specified on the request, then the
         property will be cleared for the file. Subsequent calls to "Read & Get
         Properties" will not return this property unless it is explicitly set
         on that file again.
        ...
        :param x_ms_properties: Optional.  User-defined properties to be
         ...
         list of name and value pairs "n1=v1, n2=v2, ...", where each value is
         a base64 encoded string. Note that the string may only contain ASCII
         characters in the ISO-8859-1 character set. Valid only for the
         setProperties operation. If the file or directory exists, any
         properties not included in the list will be removed.  All properties
         are removed if the header is omitted.  To merge new and existing
         properties, first get all existing properties and the current E-Tag,
         then make a conditional request with the E-Tag and include values for
         all properties.
        :type x_ms_properties: str
        ...
        if content_md5 is not None:
            header_parameters['Content-MD5'] = self._serialize.header("content_md5", content_md5, 'str')
        if x_ms_lease_id is not None:
            header_parameters['x-ms-lease-id'] = self._serialize.header("x_ms_lease_id", x_ms_lease_id, 'str', pattern=r'^[{(]?[0-9a-f]{8}[-]?([0-9a-f]{4}[-]?){3}[0-9a-f]{12}[)}]?$')
        if x_ms_cache_control is not None:
            header_parameters['x-ms-cache-control'] = self._serialize.header("x_ms_cache_control", x_ms_cache_control, 'str')
        ...
        if x_ms_content_md5 is not None:
            header_parameters['x-ms-content-md5'] = self._serialize.header("x_ms_content_md5", x_ms_content_md5, 'str')
        if x_ms_properties is not None:
            header_parameters['x-ms-properties'] = self._serialize.header("x_ms_properties", x_ms_properties, 'str')
        ...
        # Construct body
        # luisj - Manual change - Some operations having issues with the autogenerated version
    ...
    def read(
            self, filesystem, path, range=None, x_ms_lease_id=None, x_ms_range_get_content_md5=None, if_match=None, if_none_match=None, if_modified_since=None, if_unmodified_since=None, x_ms_client_request_id=None, timeout=None, x_ms_date=None, custom_headers=None, raw=False, callback=None, **operation_config):
        """Read File.
        ...
        :type range: str
        :param x_ms_lease_id: Optional. If this header is specified, the
         operation will be performed only if both of the following conditions
         are met: i) the path's lease is currently active and ii) the lease ID
    ...
    def get_properties(
            self, filesystem, path, action=None, upn=None, x_ms_lease_id=None, if_match=None, if_none_match=None, if_modified_since=None, if_unmodified_since=None, x_ms_client_request_id=None, timeout=None, x_ms_date=None, custom_headers=None, raw=False, **operation_config):
